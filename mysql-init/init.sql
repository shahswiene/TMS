...
-- Rename agents table to wazuh_agent
...
-- Indexes for wazuh_agent table
CREATE INDEX idx_wazuh_agent_name ON wazuh_agent(name);
CREATE INDEX idx_wazuh_agent_ip ON wazuh_agent(ip_address);
CREATE INDEX idx_wazuh_agent_status ON wazuh_agent(status);
...
-- Insert default wazuh agents (previously agents)
INSERT INTO wazuh_agent (name, ip_address, operating_system, cluster_node, version, registration_date, status) VALUES
