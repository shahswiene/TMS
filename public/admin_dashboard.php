...
require_once 'admin_common_components.php';
require_once 'admin_dashboard_components.php';
...
$content = '<h1 class="h3 mb-4">Admin Dashboard</h1>';
...
$content .= '<script src="/assets/js/admin_dashboard.js"></script>';

// Render the page
echo render_page('Admin Dashboard', $content, 'Dashboard');